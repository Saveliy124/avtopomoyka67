...
import { getExtraServices, createExtraService, updateExtraService, deleteExtraService } from '../controllers/extraServiceController.js';
...
router.delete('/:id', authRequired, requirePermission(PERMISSIONS.MANAGE_SERVICES), deleteExtraService);
